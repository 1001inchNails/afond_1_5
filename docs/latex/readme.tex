...
Activar auto deploy en la configuración avanzada del proyecto (Coolify dashboard)
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{43.png}
    \caption{Activar auto deploy}
\end{figure}
\FloatBarrier

Ir a la pestaña de Webhooks, crear un secret y ponerselo.
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{44.png}
    \caption{Introducir secret}
\end{figure}
\FloatBarrier
...
Comprobamos que haga el ping correctamente
\begin{figure}[h!]
    \centering
...
Comprobamos en Github que el push se haya detectado correctamente
...
Volvemos al navegador y F5 para comprobar que el auto deploy se ha ejecutado correctamente
